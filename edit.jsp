...
try{
    ...
    PreparedStatement ps = conn.prepareStatement("update tb_data set tname=?,temail=?,demo_d_cnt=?,demo_d_amt=?,demo_d_amt_tot=?,demo_n_cnt=?,demo_n_amt=?,demo_n_amt_tot=?,paid_d_cnt=?,paid_d_amt=?,paid_d_amt_tot=?,paid_n_cnt=?,paid_n_amt=?,paid_n_amt_tot=?,ccnto=?,co_amt=?,co_amt_tot=?,ct_cnt=?,ct_amt=?,ct_amt_tot=?,cr_cnt=?,cr_amt=?,cr_amt_tot=?,cf_cnt=?,cf_amt=?,cf_amt_tot=?,days=?,gross_tot=?,net_amt_pay=? where user_id='"+tid+"'");
    ps.setString(1,name);
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="input-group">
					 <div class="input-group-append">
                      ...
                      <input type="text" class="form-control" name="tname" value='<%=request.getParameter("tname") %>' >
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
					 <div class="input-group-append">
                      ...
                      <input type="email" class="form-control" name="tmail" value='<%=request.getParameter("tmail") %>'>
                    </div>
                  </div>  
                  ...
                  <hr>
		                  ...
		                  <div class="form-group row">
			                    ...
			                    <div class="col-sm-8">
			                      <input type="text" name="days" value='<%=request.getParameter("days") %>'>                       
			                    </div>
			                  </div> 
		                  ...
		                  <br>
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="demo_d_cnt" value='<%=request.getParameter("demo_d_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="demo_d_amt" value='<%=request.getParameter("demo_d_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="demo_n_cnt" value='<%=request.getParameter("demo_n_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="demo_n_amt" value='<%=request.getParameter("demo_n_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="paid_d_cnt" value='<%=request.getParameter("paid_d_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="paid_d_amt" value='<%=request.getParameter("paid_d_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>			                 
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="paid_n_cnt" value='<%=request.getParameter("paid_n_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="paid_n_amt" value='<%=request.getParameter("paid_n_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
							...
							<hr>	
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="ccnto" value='<%=request.getParameter("ccnto") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="co_amt" value='<%=request.getParameter("co_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="ct_cnt" value='<%=request.getParameter("ct_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="ct_amt" value='<%=request.getParameter("ct_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="cr_cnt" value='<%=request.getParameter("cr_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="cr_amt" value='<%=request.getParameter("cr_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
			                  ...
			                  <div class="form-group row" align="center">
			                    ...
			                    <div class="col-sm-4">
			                      <!-- text input -->
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="cf_cnt" value='<%=request.getParameter("cf_cnt") %>'>                        
			                      </div>
			                    </div>
			                    <div class="col-sm-4">
			                      <div class="form-group">
			                        <input type="text" class="form-control" name="cf_amt" value='<%=request.getParameter("cf_amt") %>'>                       
			                      </div>
			                    </div>              
			                  </div>
			       
                  <input type="hidden" class="form-control" name="tid" value='<%=request.getParameter("tid") %>'>
                  <input type="hidden" class="form-control" name="submit" value='yes'>
